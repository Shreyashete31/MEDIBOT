  ...
  createAccessibilityPanel() {
    ...
    this.panel.innerHTML = `
      ...
      <div style="margin-bottom: 1rem;">
        ...
        <select id="fontSizeSelect" style="width: 100%; padding: 0.5rem; border: 1px solid var(--border-color); border-radius: 4px;">
      ...
      <div style="display: flex; gap: 0.5rem;">
        <button id="resetSettings" style="flex: 1; padding: 0.5rem; background: var(--background); border: 1px solid var(--border-color); border-radius: 4px; cursor: pointer;">
          Reset
        </button>
