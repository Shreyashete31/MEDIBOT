  ...
  <script>
    ...
    function ensurePrepTimes(remedies) {
      return remedies.map(r => {
        const has = r.prepTime && String(r.prepTime).trim() && r.prepTime !== '—';
        return has ? r : { 
          ...r, 
    ...
    function generateExpandedRemedies(count) {
      ...
      const families = [
        { baseId:'steam-inhalation', baseTitle:'Steam Inhalation', category:'Respiratory', image:'🌬️', baseDesc:'Gentle steam for nasal comfort', baseIng:['Hot water'], variants:['Eucalyptus','Peppermint','Thyme','Chamomile','Lavender','Rosemary'] },
        { baseId:'saltwater-gargle', baseTitle:'Salt Water Gargle', category:'Respiratory', image:'💧', baseDesc:'Warm saline rinse for throat comfort', baseIng:['Salt','Warm water'], variants:['Turmeric','Baking Soda','Thyme','Sage','Honey'] },
        { baseId:'tulsi-ginger-tea', baseTitle:'Tulsi Ginger Tea', category:'Respiratory', image:'🌿', baseDesc:'Warm herbal tea for cough relief', baseIng:['Tulsi','Ginger','Water'], variants:['Honey','Lemon','Cinnamon'] },
        { baseId:'ors-home', baseTitle:'Home ORS Solution', category:'Digestion', image:'💧', baseDesc:'Hydrating oral rehydration drink', baseIng:['Water','Sugar','Salt'], variants:['Lemon','Cumin'] },
        { baseId:'curd-rice', baseTitle:'Curd Rice Soother', category:'Digestion', image:'🍚', baseDesc:'Gut-friendly bland meal for recovery', baseIng:['Curd','Cooked rice'], variants:['Cumin','Ginger','Banana'] },
        { baseId:'banana-rice-water', baseTitle:'Banana Rice Water', category:'Digestion', image:'🍌', baseDesc:'Pectin-rich soothing drink', baseIng:['Banana','Rice water'], variants:['Honey','Cinnamon'] },
        { baseId:'acv-tonic', baseTitle:'Apple Cider Vinegar Tonic', category:'Digestion', image:'🍎', baseDesc:'Tangy digestive support', baseIng:['Apple cider vinegar','Water','Honey'], variants:['Cinnamon','Ginger','Lemon'] },
        { baseId:'turmeric-milk', baseTitle:'Turmeric Golden Milk', category:'Immunity', image:'🥛', baseDesc:'Comforting anti-inflammatory drink', baseIng:['Turmeric','Milk','Black pepper'], variants:['Ginger','Cinnamon','Cardamom'] },
        { baseId:'garlic-broth', baseTitle:'Garlic Immunity Broth', category:'Immunity', image:'🥣', baseDesc:'Warm savory infusion for immune support', baseIng:['Garlic','Water','Ginger'], variants:['Thyme','Turmeric','Lemon'] },
        { baseId:'peppermint-tea', baseTitle:'Peppermint Tea', category:'Digestion', image:'🍵', baseDesc:'Cooling herbal infusion', baseIng:['Peppermint','Water'], variants:['Fennel','Chamomile','Honey'] },
        { baseId:'magnesium-bath', baseTitle:'Magnesium Epsom Bath', category:'Pain', image:'🛁', baseDesc:'Mineral soak to relax muscles', baseIng:['Epsom salt','Warm water'], variants:['Lavender','Frankincense'] },
        { baseId:'ginger-honey-lemon', baseTitle:'Ginger Honey Lemon Tea', category:'Respiratory', image:'🫖', baseDesc:'Soothing tea for coughs', baseIng:['Ginger','Honey','Lemon','Water'], variants:['Cinnamon'] }
      ];

      const skinTypes = ['Oily','Dry','Combination','Sensitive','Acne-Prone','Mature'];
      const skinPacks = [
        { baseId:'besan-turmeric-pack', baseTitle:'Besan Turmeric Pack', image:'🌸', baseIng:['Gram flour','Turmeric','Yogurt or rose water'], types:{ Oily:['Rose water'], Dry:['Yogurt'], Combination:['Yogurt','Rose water'], Sensitive:['Aloe'], 'Acne-Prone':['Tea tree'], Mature:['Honey'] } },
        { baseId:'multani-mitti-pack', baseTitle:'Multani Mitti Clarifying Pack', image:'🌸', baseIng:['Multani mitti','Rose water'], types:{ Oily:['Lemon'], Dry:['Milk','Honey'], Combination:['Aloe'], Sensitive:['Cucumber'], 'Acne-Prone':['Neem'], Mature:['Saffron'] } },
        { baseId:'oat-yogurt-mask', baseTitle:'Oat Yogurt Mask', image:'🌸', baseIng:['Oats','Yogurt','Honey'], types:{ Oily:['Lemon'], Dry:['Olive oil'], Combination:['Aloe'], Sensitive:['Cucumber'], 'Acne-Prone':['Turmeric'], Mature:['Vitamin E'] } },
        { baseId:'aloe-cucumber-gel', baseTitle:'Aloe Cucumber Gel', image:'🌿', baseIng:['Aloe','Cucumber'], types:{ Oily:['Witch hazel'], Dry:['Honey'], Combination:['Rose water'], Sensitive:['Chamomile'], 'Acne-Prone':['Tea tree'], Mature:['Vitamin E'] } }
      ];
      ...
      const specials = [
        ...
        },
        {
          ...
          instructions: ['Boil water and add coriander seeds','Simmer 7–8 minutes and strain','Sweeten lightly and sip warm'],
    ...
    function shareRemedy(remedyId) {
      ...
      if (navigator.share) {
        try { navigator.share({ title: remedy.title, text: shareText, url: window.location.href }); return; } catch(e) {}
      }
      if (navigator.clipboard && navigator.clipboard.writeText) {
        navigator.clipboard.writeText(shareText).then(() => { alert('Remedy details copied to clipboard!'); }).catch(()=>fallbackCopy(shareText));
      } else {
